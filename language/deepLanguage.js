...
function LanguageSetLanguage( newLanguageCode )
{
	...
	if ( this.currentLanguageCode == newLanguageCode )
	{
	...
	if ( document.body != null )
	{
		...
		scriptObject.src     = '../language/' + newLanguageCode + '.js';
	...
	else
	{
		...
		document.write( '<script id="languageFile" type="text/javascript" src="../language/' + newLanguageCode + '.js" charset="utf-8"></scr' + 'ipt>' );
	}
